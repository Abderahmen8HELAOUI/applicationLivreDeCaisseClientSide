...
import { authenticateUser } from '../fn/auth-controller/authenticate-user';
import { AuthenticateUser$Params } from '../fn/auth-controller/authenticate-user';
import { logoutUser } from '../fn/auth-controller/logout-user';
import { LogoutUser$Params } from '../fn/auth-controller/logout-user';
import { registerUser } from '../fn/auth-controller/register-user';
import { RegisterUser$Params } from '../fn/auth-controller/register-user';
...
export class AuthControllerService extends BaseService {
  ...
  static readonly RegisterUserPath = '/api/auth/signup/{organismId}/organism';
  ...
  static readonly LogoutUserPath = '/api/auth/signout';
   ...
   */
  logoutUser$Response(params?: LogoutUser$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
   ...
   * This method doesn't expect any request body.
   */
  logoutUser(params?: LogoutUser$Params, context?: HttpContext): Observable<{
}> {
